...
`tosstrader` can download a local copy of the canonical Toss Securities OpenAPI JSON so development can verify API assumptions against a concrete contract, not only prose docs.
